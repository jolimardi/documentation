  ...
  presets: [
    [
      ...
      ({
        ...
        theme: {
          customCss: [require.resolve('./src/css/custom.css'),require.resolve('./src/css/jolimardi-css/vars.css'),  require.resolve('./src/css/jolimardi-css/dist/jolimardi-scoped.css')],
        },
      }),
    ],
  ],
